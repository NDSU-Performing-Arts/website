<?php 
//Edit the following:
$config['page-title'] = "Marc Devine | Department of Theatre Arts";
...
<section>
	...
	<article>
		...
		<ul>
			<li>M.F.A., Contemporary Performance from Naropa University</li>
			<li>B.A., Acting from the College of Santa Fe<br>
			</li>
		</ul>
