<nav id="ndsunav" class="navbar navbar-expand-lg navbar-light">
	...
	<div class="collapse navbar-collapse" id="ndsunav-collapse">
		<ul class="navbar-nav mr-auto">
			<li class="dropdown"><a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="Button" aria-haspopup="true" aria-expanded="false" id="PDrop">ABOUT</a>
			...
			<li class="dropdown"><a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="Button" aria-haspopup="true" aria-expanded="false" id="PSDrop">PROSPECTIVE STUDENTS</a>
			...
			<li class="dropdown">
				<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" role="Button" aria-haspopup="true" aria-expanded="false" id="OSDrop">EVENTS</a>
...
<?php include($config['path'].'resources/zz-music-dates.php');?>