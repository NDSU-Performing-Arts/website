<?php 
//Edit the following:
$config['page-title'] = "Graduate Voice Auditions | Challey School of Music";
...
<div class="col-md-12" id="">
 ...
 <h1>Voice Performance: Graduate Audition Information and Requirements</h1>
		...
		<p>
		<ol>
			<li>Prepare four classical vocal selections:
				<ol type="a">
					<li>At least 1 aria from an opera or an oratorio, mass, cantata, etc.<a href="#but">***</a> sung in the original language and key.</li>
					<li>At least 1 art song in English.</li>
					<li>At least 1 art song in French or German.</li>
					<li>A fourth selection of your choosing.</li>
				</ol>
			</li>
			<li>All repertoire must be sung from memory.</li>
			<li>Your selections must be contrasting in a variety of keys and moods and must represent a variety of major musical eras chosen from the Renaissance, Baroque, Classical, Romantic, and/or Modern periods.</li>
			<li>Your selections must cover English plus at least two languages chosen from French, German, and Italian. Additional languages such as Russian, Czech, Spanish, and Latin are welcome in the audition, but are not required.</li>
		</ol>
		</p>
		</div>

		<div class="alert alert-warning mb-3">
		<h2>Doctor of Musical Arts in Voice Repertoire Requirements</h2>
		<p>
		<ol>
			<li>Prepare six classical vocal selections:
				<ol type="a">
					<li>At least 1 opera aria in the original key and language.</li>
					<li>At least 1 aria from a standard oratorio, mass, cantata, etc.<a href="#but">***</a> in the original key and language.</li>
					<li>At least 1 art song in English.</li>
					<li>At least 1 art song in French.</li>
					<li>At least 1 art song in German.</li>
					<li>A sixth selection of your choosing.</li>
				</ol>
			</li>
			<li>All repertoire must be sung from memory.</li>
			<li>Your selections must be contrasting in a variety of keys and moods and must represent at least three major musical eras chosen from the Renaissance, Baroque, Classical, Romantic, and/or Modern periods.</li>
			<li>Your selections must demonstrate proficiency in English, French, German, and Italian lyric diction. Additional languages such as Russian, Czech, Spanish, and Latin are welcome in the audition, but are not required.</li>
		</ol>
		</p>
		</div>
