<?php 
//Edit the following:
$config['page-title'] = "Collaborative Piano Auditions | Challey School of Music";
...
<div class="col-md-12" id="">
 ...
 <h1>Collaborative Piano Audition Information and Requirements</h1>
        ...
        <ul>
          <li>An outer movement of a Sonata by Beethoven or Brahms for violin, cello, or clarinet; or the  2nd movement of the Franck Violin Sonata.</li>
          <li>A set of three or more  contrasting art songs, including at least one song by Franz Schubert</li></ul>
        <p>And, for D.M.A. applicants only, either:</p>
        One of the following arias:
		<ul>
			
              <li>Any Mozart operatic aria<br>
              </li>
        ...
        <div class="alert alert-primary">If you have any questions regarding the audition requirements, please contact Dr. Tyler Wottrich at <a href="mailto:Tyler.Wottrich@ndsu.edu">Tyler.Wottrich@ndsu.edu</a> or 701.231.7884.</div>
