...
<div class="card"><a name="lowbrass" class="nu"></a>
	<div class="card-header"><h2>Low Brass</h2></div>
	<div class="card-body">
...
<div class="card"><a name="strings" class="nu"></a>
	...
	<div class="card-body">
		<div class="alert alert-warning"><strong>If you have any questions pertaining to the audition process, and/or to schedule an audition, please contact Jennifer Tackling at <a href="mailto:jennifer.tackling@ndsu.edu">jennifer.tackling@ndsu.edu</a> for upper strings and Elise Buffat Nelson at <a href="mailto:elise.buffatnelson@ndsu.edu">elise.buffatnelson@ndsu.edu</a> for lower strings.</strong></div>
