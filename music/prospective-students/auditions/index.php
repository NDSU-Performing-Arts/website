...
<div class="card"><a name="flute" class="nu"></a>
	<div class="card-header"><h2>Flute</h2></div>
	<div class="card-body">
		<div class="alert alert-warning"><strong>Please contact Dr. Laura Kellogg at <a href="mailto:laura.kellogg@ndsu.edu">laura.kellogg@ndsu.edu</a> for any questions pertaining to the audition requirements, and/or to schedule an audition.</strong></div>
		...
		<h3>Graduate Students (MM only):</h3>
...
<div class="card"><a name="clarinet" class="nu"></a>
	<div class="card-header"><h2>Clarinet</h2></div>
	<div class="card-body">
...
<div class="card"><a name="saxophone" class="nu"></a>
	<div class="card-header"><h2>Saxophone</h2></div>
	<div class="card-body">
...
<div class="card"><a name="trumpet" class="nu"></a>
	<div class="card-header"><h2>Trumpet</h2></div>
	<div class="card-body">
...
<div class="card"><a name="tuba" class="nu"></a>
	...
	<div class="card-body">
		...
		1. Scales:
		<ul>
			<li>Major Scales: Bb (Two Octaves), C &amp; F (One Octave)</li>
		</ul>
		2. Solos:
		<ul>
			<li>Two Contrasting Works (Etudes or Solo)</li>
		</ul>
		Suggested Repertoire:
		<br />
		<em>Studies</em>:		
		<ul>
			<li>Bordogni/Rochut: Melodious Etudes, Vol. 1</li>
			<li>Blazhevich Book 1</li>
			<li>Arban: Complete Method</li>
		</ul>
		<em>Solos</em>:
		<ul>
			<li>Capuzzi: Andante and Rondo </li>
			<li>Gregson: Tuba Concerto </li>
			<li>Haddad: Suite for Tuba </li>
			<li>Lebedev: Concerto in One Movement </li>
			<li>Marcello: Sonata No. 1 in F Major</li>
			<li>Barat: Introduction and Dance</li>
			<li>Bach: Air and Bouree</li>
		</ul>
	</div><!--card-body-->
</div><!--card-->
...
<div class="card"><a name="percussion" class="nu"></a>
	<div class="card-header"><h2>Percussion</h2></div>
	<div class="card-body">
