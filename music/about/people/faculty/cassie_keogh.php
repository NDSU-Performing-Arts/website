<?php 
//Edit the following:
$config['page-title'] = "Dr. Cassie Keogh | Challey School of Music";
...
<div class="col-md-4">
	<img alt="music_faculty"
		 src="images/200px_faculty_keogh_cassie.gif"
