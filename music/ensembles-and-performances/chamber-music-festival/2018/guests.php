<?php 
//Edit the following:
$config['page-title'] = "Chamber Music Festival 2018 | Challey School of Music";
...
<ul class="nav nav-tabs mt-3">
  <li class="nav-item">
    <a class="nav-link" href="../">2018 Chamber Music Festival</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="concerts.php">Concerts</a>
  </li>
  <li class="nav-item">
    <a class="nav-link active" href="guests.php">Guest Artists</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="students.php">Student Artists</a>
  </li>
</ul>

<!--	<header>
		<h1><a href="../">Home</a> | <a href="concerts.php">Concerts</a> | <a href="guests.php">Guest Artists</a> | <a href="students.php">Student Artists</a></h1>
	</header>-->
		...
		<table class="table table-striped">
			<tbody>
				<tr>
					<td>
						<img alt=""
							 src="../../../people/faculty/images/200px_faculty_buffatnelson_elise.jpg"
							 width="100px"
							 style="width: 100px;">
					</td>
					<td>
						<h2>Elise Buffat-Nelson, cello</h2>
						
						<p>Elise Buffat Nelson serves as Adjunct Professor of cello at North Dakota State University in addition to serving the same position at Minnesota State University-Moorhead. She is the associate principal cello of the Fargo-Moorhead Symphony Orchestra and a member of the Dakota Rose String Quartet. She has been a private cello instructor and coach since 1989 and currently maintains an extensive private studio.</p>
						<p>Ms. Nelson earned her master of music degree from the University of Wisconsin-Madison where she studied with Parry Karp. She was also a member of the Strelow Quartet, the graduate string quartet coached by members of the Pro Arte Quartet. Her bachelor of music degree was earned at the University of Wisconsin-Superior where she studied with Eugenia Slezak.</p>
						<p>Prior to moving to the Fargo-Moorhead area, Elise was the associate principal cello of the Arkansas Symphony Orchestra and full-time member of the resident string quartet, the Quapaw Quartet. In addition to her position with the Arkansas Symphony Orchestra, she has performed with the Madison Symphony Orchestra, the Wisconsin Chamber Orchestra, and the Duluth-Superior Orchestra.</p>
				...
				<tr>
					<td>
						<img alt=""
							 src="../images/100px_william.jpg"
							 width="100px"
							 style="width: 100px;">
					</td>
					<td>
						<h2>William Comita, cello</h2>
				...
				<tr>
					<td>
						<img alt=""
							 src="../images/100px_tim.jpg"
							 width="100px"
							 style="width: 100px;">
					</td>
					
					<td>
						<h2>Timothy Nelson, viola</h2>
						<p>Tim Nelson is currently the orchestra teacher at South High School in Fargo, Principal Violist with the Fargo Moorhead Symphony, violist with the FM Symphony’s 8th Street Quartet, and an adjunct viola instructor at Minnesota State University, Moorhead. The 8th Street Quartet maintains an active concert schedule in the North Dakota/Minnesota region, performing chamber music from Bach to the twenty-first century.</p>
						<p>He received a BM degree from the University of Wisconsin, Superior and an MM from the Juilliard School, with emphasis in viola performance.</p>
						<p>For the ten years preceding coming to the Fargo Moorhead area he was principal violist with the Arkansas Symphony in Little Rock, and violist in the Quapaw String Quartet, the members of which formed the full time salaried core of the Arkansas Symphony.</p>
						<p>Mr. Nelson has played in the viola sections of many orchestras, including the Duluth Superior Symphony Orchestra, the Madison (Wisconsin) Symphony, the Wisconsin Chamber Orchestra and the Queens Philharmonic.</p>
						</td>
				</tr>
				...
				<tr>
					...
					<td>
						...
						<p>Clara’s passion for contemporary music is exhibited in the song-cycles she has premiered by numerous composers with the Center for New Music at the University of Iowa, and her most recent collaborations with Linda Kachelmeier (Stars), Jeremy Walker (Alma Gentil), Linda Tutas Haugen (Gjendine’s Lullaby), Paul Rudoi (Midnight Songs) and James Kallembach (St. John Passion and Songs on Letters of John and Abigail Adams).</p>
						<p>Clara will be on faculty at Aspen Music Festival's Professional Choral Institute in partnership with Seraphic Fire in August of 2018. Clara currently studies voice with Emma Small of Minneapolis and aspires to be as kind and as generous as Emma. In addition to performing, Clara serves as the Associate Artistic Director of <a href="http://www.sourcesongfestival.org/">Source Song Festival</a>, a week-long art song festival in Minneapolis, Minnesota. The festival will be in its fifth season August 5-11th, 2018. In addition to her solo work, she participates in a number of ensembles, including <a href="https://www.luminawomensensemble.com/">Lumina Women’s Ensemble</a> and <a href="http://www.seraphicfire.org/">Seraphic Fire</a>.</p>
				...
				<tr>
					<td>
						<img alt=""
							 src="../images/100px_yoo.jpg"
							 width="100px"
							 style="width: 100px;">
					</td>
					
					<td>
						<h2>Alice Yoo, cello</h2>
						
						<p>Cellist Alice Yoo has warmly been hailed for her sensitive musicianship, expressive nuance, and passionate commitment to chamber music and teaching. </p>
						<p>As chamber musician, she has collaborated with distinguished artists such as Itzhak Perlman, Mitsuko Uchida, Pamela Frank, Kim Kashkashian, Midori Goto, Miriam Fried, Jonathan Biss, and members of the Cleveland, Guaneri, and Juilliard Quartets. Festival appearences include Marlboro Music Festival, Caramoor’s Evnin Rising Stars, Ravinia Festival’s Steans Institute, Yellow Barn, IMS Open Chamber Music, and Music@Menlo. </p>
						<p>She frequently performs with ensembles such as The Knights, East Coast Chamber Orchestra, Metropolis Ensemble, Colorado Symphony, and A Far Cry. Passionate for new music, Alice has worked closely with the esteemed composers Sophia Gubaidulina, Jennifer Hidgon, György Kurtág, and John Harbison. </p>
						<p>Alice has won top prizes in the USC Concerto Compeition, Holland-America Music Society Competition, Schadt International String Competition, and Klein International String Competition. Alice has appeared as soloist with the USC Chamber Orchestra, Cleveland Philharmonic, New York Classical Players, Billings Symphony, and the Bozeman Symphony. Her performances have been featured and broadcasted on Los Angeles’ KUSC, Chicago’s WFMT, and Boston’s WGBH.</p>
						<p>A native of Bozeman, Montana, Alice began her cello studies with  Dr. Ilse-Mari Lee and was a pupil of Richard Aaron in the Cleveland Institute of Music's Young Artist Program. She earned a Bachelor of Music Degree from the New England Conservatory, studying with Paul Katz. Under the tutelage of Ralph Kirshbaum, she received a Post-Graduate diploma from the Royal Northern College of Music in Manchester, England and a Masters Degree from the University of Southern California’s Thornton School of Music. She currently resides in Denver, Colorado.</p>
						</td>
				</tr>
				...
				<tr>
					<td>
						<img alt=""
							 src="../../../people/faculty/images/200px_faculty_york_elizabeth.jpg"
							 width="100px"
							 style="width: 100px;">
					</td>
					
					<td>
						<h2>Elizabeth York, violin</h2>
						
						<p>Elizabeth York holds a dual DMA in violin and viola performance from Stony Brook University. She is lecturer of upper strings at North Dakota State University, and teaches violin and viola students in the Twin Cities. In recent summers she has taught at Birch Creek Symphony Session, Upper Midwest String Camp, and MN All-State Orchestra camp. She is currently serving a one-year position as Associate Principal 2nd violin of the South Dakota Symphony Orchestra. </p>
						<p>Elizabeth’s chamber music and recital performances have included appearances at Steinway Hall (New York City), Southampton Cultural Center (NY), The Baroque Room (St. Paul), the Schubert Club’s courtroom concert series, Sioux Falls Chamber Music Collective, NDSU Chamber Music Festival, Four Seasons Chamber Music Festival “Next Generation” series, and with members of the Emerson String Quartet as part of the Stony Brook Chamber Music Festival.</p>
						<p>Experienced in historical performance practice, Elizabeth plays baroque violin and viola with Lyra Baroque Orchestra, where she also serves on the board of directors. She recently performed in MN and Germany with The Rose Ensemble, and appears on their newest recording, Christmas in Baroque Malta. 

						<p>Elizabeth holds a BM from East Carolina University and MM from Stony Brook University, both in violin performance. Her major teachers include violinists Ara Gregorian, Soovin Kim, and Phil Setzer, and violists Dan Panner, Nicholas Cords, and Lawrence Dutton.</p>
