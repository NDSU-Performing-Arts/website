<?php 
//Edit the following:
$config['page-title'] = "Chamber Music Festival | Challey School of Music";
...
<ul class="nav nav-tabs mt-3">
  <li class="nav-item">
    <a class="nav-link active" href="index.php">2019 Chamber Music Festival</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="2018/concerts.php">Concerts</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="2018/guests.php">Guest Artists</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="2018/students.php">Student Artists</a>
  </li>
</ul>	<br /> -->
	<header>
	...
	<p>August 31-September 1, 2020<br>-->
	<!--Videos-->
	<br />
	<br />
...
<div class="col-md-3">
	...
	<div class="card"><div class="card-body">
		...
		<div class="col-md-9">
		  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/videoseries?list=PL-lgQtP2mPVSaA32IWeTGmVqirzIHNg50" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
	</div>
	<div class="col-md-3">
	<ol class="">
		<li>Colin Carr and Tyler Wottrich performing Beethoven's Magic Flute Variations from the 2016 Festival</li>
		<li>Benton Schmidt, Elizabeth York, and William Comita performing the 2nd movement of Beethoven's Piano Trio in Eb, Op. 1 No. 1</li>
		<li>Carson Covey, Sonja Bosca-Harasim, and Marie-Elaine Gagnon performing the 3rd movement of Turina's Piano Trio No. 1, Op. 35.</li>
		<li>Cydney Berlinger, Grace Park, and Alice Yoo performing the 4th movement of Shostakovich's Piano Trio in E Minor, Op. 67</li>
	</ol>
	</div>
	</div></div>
	</div><!--row-->
...
<div class="row">
<article id="archive">
		<h2>Previous Chamber Music Festivals</h2>
		
		<h3>2018</h3>
		<p><a href="2018/concerts.php">Concerts</a> | <a href="2018/guests.php">Guests</a> | <a href="2018/students.php">Students</a></p>
		
		<h3>2017</h3>
		<p><a href="2017/concerts.php">Concerts</a> | <a href="2017/guests.php">Guests</a> | <a href="2017/students.php">Students</a></p>
		
		<h3>2016</h3>
		<p><a href="2016/concerts.php">Concerts</a> | <a href="2016/guests.php">Guests</a></p>
		
		<!--<h3>2015</h3>
		
		<p><a href="2015/"></a> | <a href="2015/"></a> | <a href="2015/"></a></p>-->
	</article>
</div>
</section>
