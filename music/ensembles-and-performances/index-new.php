		...
		<div class="card mb-3">
			...
			<div id="GSMB" aria-labelledby="GSMBHeading">
				<div class="card-body">
					...
					<a href="<?php $terms = "GSMB"; echo "https://www.ndsu.edu/eventcalendar/main.php?view=searchresults&keyword=".$terms."&timebegin_month=".date(m)."&timebegin_day=".date('d')."&timebegin_year=".date('Y');?>" class="btn btn-success"><i class="fas fa-calendar-alt"></i> View Performances</a>
		...
		<div class="card mb-3">
			...
			<div id="Jazz" aria-labelledby="JazzHeading">
				<div class="card-body">
					...
					<a class="btn btn-ndsu-green" data-toggle="collapse" href="#jazz-collapse" role="button" aria-expanded="false" aria-controls="jazz-collapse"><i class="fas fa-plus"></i> More Information</a> 
		...
		<div class="card mb-3">
			...
			<div id="Opera" aria-labelledby="OperaHeading">
				<div class="card-body">
					...
					<div class="alert alert-success">
						<i class="fa fa-user-circle fa-fw"></i> Dr. Mariane Lemieux, <a href="mailto:mariane.lemieux@ndsu.edu">mariane.lemieux@ndsu.edu</a>.<br />
		...
		<div class="card mb-3">
			...
			<div id="UBand" aria-labelledby="UBandHeading">
				<div class="card-body">
					...
					<a href="<?php $terms = "University Band"; echo "https://www.ndsu.edu/eventcalendar/main.php?view=searchresults&keyword=".$terms."&timebegin_month=".date(m)."&timebegin_day=".date('d')."&timebegin_year=".date('Y');?>" class="btn btn-success"><i class="fas fa-calendar-alt"></i> View Performances</a>
